...
> This is the repo to practice working with rails api and rails as a backend application. Here is the link to the [frontend](https://github.com/LeslieAine/hello-react-front-end)
...
```sh
  ...
  git clone git@github.com:LeslieAine/hello-rails-backend.git
...
Feel free to check the [issues page](https://github.com/LeslieAine/hello-rails-backend/issues).
